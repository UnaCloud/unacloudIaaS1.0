...
public class DatabaseConnection{
	...
	/*
	 * Statement es la funci�n que ejecuta la sentencia SQL Le llamamos Query,
	...
	/*
	 * ResultSet es la funci�n que recibe el resultado generado por la funci�n
	 * Statement
	 */
	...
	/*
	 * Connection es la Clase que nos permite la conexión a SQL Server, al
	 * igual que Statement y ResultSet esta función solo se puede utilizar si
	 * importamos las librerías de SQL en nuestro programa, lo cual hacemos
	 * con: import java.sql.*;
	 */
	...
	public Connection conectar() {
		...
		String url = "jdbc:mysql://" + ip + ":3306/" + name;
				...
				.getStringValue("MONITORING_DATABASE_NAME");*/
                String ip = "157.253.236.160";
		String name = "pruebasmonitoreo";
		String user = "pmonitoreo";
		String password = "pmonitoreo";
		String url = "jdbc:mysql://" + ip + ":3306/" + name;
		databasename = "pruebasmonitoreo";
