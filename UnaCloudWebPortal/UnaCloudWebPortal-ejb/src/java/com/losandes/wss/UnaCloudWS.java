...
public class UnaCloudWS {
    ...
    public VirtualMachineExecutionWS[] turnOnVirtualCluster(@WebParam(name = "username")
    String username, @WebParam(name = "pass")
    String pass, @WebParam(name = "templateID")
    int templateID, @WebParam(name = "size")
    int size, @WebParam(name = "ram")
    ...
    public VirtualMachineExecutionWS[] getVirtualMachineExecutions(@WebParam(name = "username")
    String username, @WebParam(name = "pass")
    String pass, @WebParam(name = "templateID")
    int templateID) {
        if(!userServ.validateUser(username, pass))return null;
    ...
    public String turnOffVirtualMachine(@WebParam(name = "username")
    String username, @WebParam(name = "pass")
    String pass, @WebParam(name = "virtualMachineExID")
    ...
    public TemplateWS[] getTemplateLists(@WebParam(name = "username")
    String username, @WebParam(name = "pass")
    String pass){
    ...
    final String password) {
        if(!userServ.validateUser(user, password))return null;
        SystemUser us=userServ.getUserByID(user);
        if(us!=null&&us.getTemplates()!=null){
            boolean tienePermiso=false;
            for(Template t:us.getTemplates())if(t.getTemplateCode()==templateSelected){
                tienePermiso=true;
                break;
            }
            if(tienePermiso){
    ...
    public Integer getTotalUnaCloudResources(@WebParam(name = "machineDisk")
    ...
    public Integer getAvailableUnaCloudResources(@WebParam(name = "machineDisk")
    int machineDisk, @WebParam(name = "machineCores")
    int machineCores, @WebParam(name = "machineRam")
    int machineRam) {
